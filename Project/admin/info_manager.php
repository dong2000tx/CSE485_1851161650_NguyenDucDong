...
<?php
	$sql = "SELECT ID, TENTAIKHOAN, MATKHAU, EMAIL, TRANGTHAI, TEN, MAQUANLY 
	        FROM taikhoan
	        INNER JOIN quanly
	        where taikhoan.ID = quanly.MAQUANLY";
	        ...
	        <table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td><a href="edit_manager.php?id=<?php echo $ID;?>">Sửa</a></td>
			      <td><a href="info_manager.php?id_delete=<?php echo $ID;?>">Xóa</a></td>
