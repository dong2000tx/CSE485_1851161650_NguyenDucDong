              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Số kế hoạch giảng dạy dự kiến</div>
            ...
            <div class="col-xl-3 col-md-3 mb-2">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Số lịch trình thực tế</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        
                        <?php 
                        $sql = "SELECT * FROM lichtrinhthucte";
                        $query = mysqli_query($conn,$sql);
                        echo mysqli_num_rows($query);
                      ?>
                      </div>
